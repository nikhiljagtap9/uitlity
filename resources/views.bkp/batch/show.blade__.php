                ...
                <div class="col-12 col-sm-6 col-md-12">
                    ...
                    <table class="table table-stripped table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <td>{{ $batch->uuid }}</td>
                                <!-- <td>{{ $batch->total_principal }}</td> -->
                                <td>₹{{ number_format($batch->total_principal, 2) }}</td>
                                <!-- <td>{{ '-' }}</td>
                                                                                                                                                                                                        <td>{{ $batch->total_interest }}</td> -->
                                <td>₹{{ number_format($batch->total_bank_interest, 2) }}</td>
                                <!-- <td>{{ $batch->total_nbfc_interest }}</td>
                                                                                                                                                                                                    <td>{{ $batch->total_mfl_sprade }}</td> -->
                                <td>₹{{ number_format($batch->total_bank_principal + $batch->total_bank_interest, 2) }}
                                </td>
                            </tr>
                        </tbody>
                    </table>
