...
class CkycValidate extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'Ckyc:CkycValidate';
    ...
    {
		$loan_accounts = Disbursement::where('batch_id', 'BATCH616516932672579')->where('status','Approved')->orderBy('id','desc')->get();
//		$loan_accounts = Disbursement::where('id',20617)->get();
	//	dd($loan_accounts);
